...
const Sidebar = () => {
  const mainNavItems = [
    { name: 'Mail', path: '/coordinator/mail', icon: '📧' },
    { name: 'Dashboard', path: '/coordinator/dashboard', icon: '📊' },
    { name: 'Availability', path: '/coordinator/availability', icon: '📅' },
    { name: 'Analytics', path: '/coordinator/analytics', icon: '📈' }
  ];

  const profileItem = { name: 'Profile', path: '/coordinator/profile', icon: '👤' };
